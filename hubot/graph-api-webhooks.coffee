...
module.exports = (robot) ->
  ...
  robot.router.get ['/facebook', '/instagram'], (req, res) ->
    if req.param('hub.mode') == 'subscribe' and req.param('hub.verify_token') == 'EAAI9XPFEUJ8BAFJkLZC0DL0K0wEZAb93SF7sxxyM0RZCTz83YZAAert4MHKPBEJ7tGLlD3xcc9NnTXbjiboTd2CTqZBMUdjCHnNakkomsi98R1Ky3ZBJU1yMtppUvu3AjDKhAjGxoflfS8HZC23fIc5xQhLoSItgOffT5SVIFoDWDgSHR6f96JZBR3hTgSgWVtMZD'
